...
const Contact = () => {
  return (
    ...
    <form action="" className="flex flex-col gap-2 lg:w-1/2 ">
      ...
      <textarea  className=" w-full my-3 rounded-lg bg-slate-800 p-4 border-2 border-fuchsia-800  b_glow text-xl text-slate-500"placeholder="Enter your Massage..."  name="" id="" cols="20" rows="10" />
